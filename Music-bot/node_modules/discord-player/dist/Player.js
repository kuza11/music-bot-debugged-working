...
class Player extends tiny_typed_emitter_1.TypedEmitter {
    ...
    _handleVoiceState(oldState, newState) {
        //var chan = client.guilds.get(newState.channelId).id;
        console.log(`${oldState.guild} ${newState.channel}`);
        ...
        if (oldState.channelId && !newState.channelId && oldState.channelId !== newState.channelId) {
            ...
            if (newState.member.id === newState.guild.me.id || (newState.member.id !== newState.guild.me.id && oldState.channelId === queue.connection.channel.id)) {
                if (queue.connection.channel === null || queue.connection.channel === undefined){
                    und = 1;
                    console.log(`null ${Boolean(und)}`);
                }
                else if (!Util_1.Util.isVoiceEmpty(queue.connection.channel))
                    return;
